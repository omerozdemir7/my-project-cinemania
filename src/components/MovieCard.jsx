...
import { getGenresText, getMovieYear, renderStars } from '../utils/uiHelpers.jsx';
...
export function MovieCard({ movie, onClick }) {
  ...
  return (
    <div className="movie-card" data-id={movie.id} onClick={() => onClick && onClick(movie.id)}>
      <img 
      ...
      <div className="movie-card-overlay">
        ...
        <div className="movie-meta">
          <span className="movie-genre">{getGenresText(genreList)} | {year}</span>
