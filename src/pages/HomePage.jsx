...
import { fetchTrendingMovies, fetchUpcomingMovies, fetchMovieDetails, getOriginalImageUrl } from '../utils/moviesApi';
      ...
      <section className="weekly-trends-section">
        <div className="container">
          <div className="section-header">
            <h2>WEEKLY TRENDS</h2>
            <Link to="/catalog" className="see-all-link">See all</Link>
          </div>
                ...
                <div className="movie-details-list">
                  <div className="detail-item">
                    ...
                    <span className="detail-value">
                      {new Date(upcomingMovie.release_date).toLocaleDateString("en-US")}
                    </span>
                  </div>
                  <div className="detail-item">
                    <span className="detail-key">Vote</span>
                    <span className="detail-value">{upcomingMovie.vote_average.toFixed(1)}</span>
                  </div>
                  <div className="detail-item">
                    <span className="detail-key">Vote Count</span>
                    <span className="detail-value">{upcomingMovie.vote_count}</span>
                  </div>
                  <div className="detail-item">
                    <span className="detail-key">Popularity</span>
                    <span className="detail-value">{upcomingMovie.popularity.toFixed(1)}</span>
                  </div>
                </div>
